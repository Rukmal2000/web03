...
import { CheckCircle, Search, LayoutDashboard, Star, Award, Users, TrendingUp } from 'lucide-react';

interface ConfirmationPageProps {
  onAction: (action: 'services' | 'dashboard') => void;
          ...
          <div className="p-12">
            ...
            <div className="bg-gray-50 rounded-2xl p-8 mb-12">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {registrationData?.role === 'consumer' && (
                  <>
                    <div className="text-center">
                      ...
                      <h5 className="font-semibold text-gray-900 mb-2">Browse Services</h5>
                      <p className="text-gray-600 text-sm">Find vehicles and materials from verified suppliers</p>
                    </div>
                    <div className="text-center">
                      <div className="bg-green-100 w-12 h-12 rounded-xl flex items-center justify-center mx-auto mb-3">
                        <CheckCircle className="w-6 h-6 text-green-600" />
                      </div>
                      <h5 className="font-semibold text-gray-900 mb-2">Contact Suppliers</h5>
                      <p className="text-gray-600 text-sm">Connect directly with vehicle owners and material suppliers</p>
                    </div>
                    <div className="text-center">
                ...
                {(registrationData?.role === 'vehicle_owner' || registrationData?.role === 'material_supplier') && (
                  <>
                    <div className="text-center">
                      <div className="bg-yellow-100 w-12 h-12 rounded-xl flex items-center justify-center mx-auto mb-3">
                        <CheckCircle className="w-6 h-6 text-yellow-600" />
                      </div>
                      <h5 className="font-semibold text-gray-900 mb-2">Complete Verification</h5>
                      <p className="text-gray-600 text-sm">Your account will be reviewed within 24-48 hours</p>
                    </div>
                    <div className="text-center">
                      <div className="bg-blue-100 w-12 h-12 rounded-xl flex items-center justify-center mx-auto mb-3">
                        <LayoutDashboard className="w-6 h-6 text-blue-600" />
                      </div>
                      <h5 className="font-semibold text-gray-900 mb-2">Create Listings</h5>
                      <p className="text-gray-600 text-sm">
                        Add your {registrationData?.role === 'vehicle_owner' ? 'vehicles' : 'materials'} to start earning
                      </p>
                    </div>
                    <div className="text-center">
                      <div className="bg-green-100 w-12 h-12 rounded-xl flex items-center justify-center mx-auto mb-3">
